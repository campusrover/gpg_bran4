#ifndef _ROS_lino_msgs_ArmMsg_h
#define _ROS_lino_msgs_ArmMsg_h
...
namespace lino_msgs
{
  ...
  class ArmMsg : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "lino_msgs/ArmMsg"; };
    virtual const char * getMD5() override { return "22db7cf47707ed15d576c944473b1120"; };
